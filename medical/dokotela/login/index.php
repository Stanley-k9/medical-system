...
<div class="form-wrapper">
  ...
  <form action="#" method="post">
	...
	<a class="back" href="../../index.html">MAKE AN APPOINTMENT</a>
	</div>
	...
	if (isset($_POST['login']))
		{
			...
			$query 		= mysqli_query($con, "SELECT * FROM doctors WHERE  password='$password' and username='$username'");
			$row		= mysqli_fetch_array($query);
			$num_row 	= mysqli_num_rows($query);
			
			if ($num_row > 0) 
				{			
					$_SESSION['Doc_id_number']=$row['Doc_id_number'];
